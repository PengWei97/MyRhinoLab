...
simu_case = {'bk2_c1_GBIsotropy','bk2_c2_GBEAniso','bk2_c3_GBEAniso','bk3_c3_GBEAniso', 'bk2_c2_GBMAniso'};  % 'bk2_c2_GBEAniso',
baseName = 'Mg_Gd_alloy';
grain_types = {'Red', 'Green', 'Others'};
simu_cases = {'GB isotropy', 'GBEAniso1: A-A*0.5', 'GBEAniso3: B-B*0.1', 'GBEAniso4: B-B*0.1', 'GBMAniso5: A-A*0.1'}; %  'GBEAniso2: A-A*0.1',
colors = {'r', 'g', 'b'};

%% 可视化参数
visParams = VisualizationParams2();
% visParams.height = 8.5;
% visParams.width = 11;
...
% H:\Github\MyRhinoLab\scripts\prm9-cooperate\p91-MgAlloy-SelectGG-2025\20250509_simulations\p92_s4_draw_kinetics_grain_type.m