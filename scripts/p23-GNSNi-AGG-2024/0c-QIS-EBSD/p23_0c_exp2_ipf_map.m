...
%% 指定文件路径 - 2
dataPath = 'H:\Github\MyRhinoLabData\p23_GNSNi_AGG_2024\ebsd\USRP5_10min_20250308\ctf_excerpt\';

for iRegion = 2:2

    inputFile = fullfile(dataPath, sprintf('S2_dd_10min_R%d_excerpt.ctf', iRegion));
...
% 脚本路径: H:\Github\MyRhinoLab\scripts\p23-GNSNi-AGG-2024\0c-QIS-EBSD\p23_0c_exp2_ipf_map.m
